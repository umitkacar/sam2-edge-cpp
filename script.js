...
document.querySelectorAll('.feature-card, .demo-box, .install-step, .tech-item').forEach(el => {
    el.style.opacity = '0';
...
console.log('%cEdgeSAM 🚀', 'font-size: 40px; font-weight: bold; background: linear-gradient(135deg, #6366f1, #ec4899); -webkit-background-clip: text; -webkit-text-fill-color: transparent;');
console.log('%cUltra-Modern AI Segmentation', 'font-size: 16px; color: #818cf8;');
console.log('%cBuilt with ❤️ using C++, ONNX Runtime & OpenCV', 'font-size: 12px; color: #cbd5e1;');
